...
final class Module_Linq extends GDO_Module
{
	...
	public function getDependencies() { return ['Material', 'Tag', 'News', 'Forum', 'Friends', 'Vote', 'Login', 'Register', 'Recovery', 'Admin', 'Account', 'Profile', 'PM', 'Perf', 'LoginAs', 'JQuery']; }
	...
	{
		$bar->addField(GDT_Link::make('link_links')->href(href('Linq', 'Links')));
	}
